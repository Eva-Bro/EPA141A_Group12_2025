# Flood Risk Management – Environmental Interest Group (EPA141A Group 12)
...
### [2_Multi_scenario_MORDM.ipynb](2_Multi_scenario_MORDM.ipynb)
...
1. [Problem formulation](2_Multi_scenario_MORDM.ipynb#step-1-problem-formulation)  
2. [Searching for candidate solutions](2_Multi_scenario_MORDM.ipynb#step-2-searching-for-candidate-solutions)  
3. [Re-evaluate candidate solutions under uncertainty](2_Multi_scenario_MORDM.ipynb#step-3-re-evaluate-candidate-solutions-under-uncertainty)  
4. [Performing a scenario discovery](2_Multi_scenario_MORDM.ipynb#step-4-performing-a-scenario-discovery)   
